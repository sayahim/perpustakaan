          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="dt" class="table table-bordered table-striped">
                ...
                <?php
                    $no=1;
                    $query="SELECT * from peminjaman P join Anggota A ON P.kd_anggota=A.kd_anggota JOIN petugas PT ON P.kd_petugas=PT.kd_petugas where status='Dipinjam'";
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="?hal=peminjaman_lihat&id=<?php echo $kd_peminjaman; ?>" class="btn btn-success"><i class="fa fa-edit"></i> Edit</a>
