	  ...
	  <div class="box-body">
	    <form class="form-horizontal" action="petugas_proses.php" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
	        ...
	        <div class="col-sm-4">
	          <input type="text" name="kode" class="form-control" value="<?php echo $kd_petugas; ?>" readonly>
	        </div>
	      ...
	      <div class="form-group">
	        ...
	        <div class="col-sm-4">
	          <input type="text" name="nama" class="form-control" value="<?php echo $nama_petugas; ?>" required>
	        </div>
	      </div>
