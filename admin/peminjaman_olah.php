            ...
            <tr>
              ...
              <th style="width: 100px">Action</th>
                ...
                if (isset($_SESSION['items'])){
                    ...
                    $no=1;
                    foreach ($_SESSION['items'] as $key=> $jml){ //$_SESSION['items'][B001]=1;
      ...
      <div class="box-footer">
        <div class="form-group">
            <?php if ((!isset($_SESSION['items'])) || ($pb_qty=="0")){ ?>
                <h5 align="center" style="color: red">Detail Peminjaman Masih Kosong !!</h5><br><br>
            <?php } ?>
  ...
  $iduser = $_SESSION['adm'];
    ...
    if (isset($_SESSION['items'])) {
        ...
        if ($savepinjam){
            ...
            $up_peminjaman = $mysqli->query("UPDATE peminjaman SET status= 'Dipinjam' WHERE kd_peminjaman='$idpinjam'");
            if ($up_peminjaman) {
